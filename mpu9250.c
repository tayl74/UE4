 ...
 Because the sensor is not 5V tolerant, we are using a 3.3 V 8 MHz Pro Mini or a 3.3 V Teensy 3.6.
...
{  
  ...
  if (readByte(MPU9250_ADDRESS, INT_STATUS) & 0x01) {  // On interrupt, check if data ready interrupt
   ...
   // magbias[2] = +125.;  // User environmental z-axis correction in milliGauss
    ...
    magbias[0] = +45.;  // User environmental x-axis correction in milliGauss, should be automatically calculated
    magbias[1] = +400.;  // User environmental x-axis correction in milliGauss
    magbias[2] = -400.;  // User environmental x-axis correction in milliGauss
    ...
    else
    {
      ...
      if (delt_t > 10)
      {
          ...
          //Serial.print(" qz = "); Serial.println(q[3]);
           ...
           hi.floatingPoint[0] = q[0]; // w
           hi.floatingPoint[1] = q[1]; // x
           hi.floatingPoint[2] = q[2]; // y
           hi.floatingPoint[3] = q[3]; // z

           //hi.floatingPoint[0] = q[1]; // x
           //hi.floatingPoint[1] = q[2]; // y
           //hi.floatingPoint[2] = q[3]; // z
           //hi.floatingPoint[3] = q[0]; // w           
...
void magcalMPU9250(float * dest1, float * dest2) 
{
  ...
  for(ii = 0; ii < sample_count; ii++)
  {
    ...
    Serial.print(" "); Serial.print(mag_min[0]);
    Serial.print(" "); Serial.print(mag_min[1]);
    Serial.print(" "); Serial.print(mag_min[2]);
    Serial.print(" "); Serial.print(mag_max[0]);
    Serial.print(" "); Serial.print(mag_max[1]);
    Serial.print(" "); Serial.print(mag_max[2]);
  ...
  Serial.print("x mag_bias "); Serial.println(mag_bias[0]);
  Serial.print("y mag_bias "); Serial.println(mag_bias[1]);
  Serial.print("z mag_bias "); Serial.println(mag_bias[2]);
  ...
  Serial.println("After Magnetometer Calibration: ");
  Serial.print("x scale "); Serial.println(dest2[0], 2);
  Serial.print("y scale "); Serial.println(dest2[1], 2);
  Serial.print("z scale "); Serial.println(dest2[2], 2);
  Serial.print("x bias "); Serial.println(dest1[0], 2);
  Serial.print("y bias "); Serial.println(dest1[1], 2);
  Serial.print("z bias "); Serial.println(dest1[2], 2);
